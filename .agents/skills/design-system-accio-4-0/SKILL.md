---
name: design-system-accio-invest-3-0
description: Creates implementation-ready design-system guidance derived from local Figma styles in "Accio Invest 3.0".
---
...
Document and operationalize the Accio Invest 3.0 style foundations extracted from Figma so teams can build consistent interfaces quickly.

## Brand

- Product/brand: Accio Invest 3.0
