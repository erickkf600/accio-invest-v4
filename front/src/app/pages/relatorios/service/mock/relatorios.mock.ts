...
export const MOCK_APORTES: RelatorioAporte[] = [
  // 2024
  { id: 'ap1', mes: 'Janeiro', ano: 2024, data: '05/01/2024', valor: 1500.00, taxas: 4.20, detalhes: 'Aporte RV (AAPL)', ativos: makeAtivos(ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.20)) },
  { id: 'ap2', mes: 'Janeiro', ano: 2024, data: '20/01/2024', valor: 1000.00, taxas: 2.60, detalhes: 'Aporte FIIs (XPML11, MXRF11)', ativos: makeAtivos(ap('XPML11', 'FII', 10, 60.00, 600.00, 1.56), ap('MXRF11', 'FII', 20, 20.00, 400.00, 1.04)) },
  { id: 'ap3', mes: 'Fevereiro', ano: 2024, data: '10/02/2024', valor: 1010.00, taxas: 2.90, detalhes: 'Aporte RV (PETR4, VALE3)', ativos: makeAtivos(ap('PETR4', 'Ação', 20, 25.25, 505.00, 1.45), ap('VALE3', 'Ação', 5, 101.00, 505.00, 1.45)) },
  ...
  { id: 'ap5', mes: 'Março', ano: 2024, data: '08/03/2024', valor: 2000.00, taxas: 5.80, detalhes: 'Aporte RV (BBDC4, ITUB4)', ativos: makeAtivos(ap('BBDC4', 'Ação', 20, 50.00, 1000.00, 2.90), ap('ITUB4', 'Ação', 10, 100.00, 1000.00, 2.90)) },
  { id: 'ap6', mes: 'Março', ano: 2024, data: '15/03/2024', valor: 2000.00, taxas: 5.40, detalhes: 'Aporte bônus RV (MSFT, TSLA)', ativos: makeAtivos(ap('MSFT', 'Ação', 2, 600.00, 1200.00, 3.24), ap('TSLA', 'Ação', 4, 200.00, 800.00, 2.16)) },
  ...
  { id: 'ap8', mes: 'Abril', ano: 2024, data: '12/04/2024', valor: 1625.00, taxas: 4.10, detalhes: 'Aporte RV (AAPL, PETR4)', ativos: makeAtivos(ap('AAPL', 'Ação', 2, 500.00, 1000.00, 2.52), ap('PETR4', 'Ação', 25, 25.00, 625.00, 1.58)) },
  ...
  { id: 'ap10', mes: 'Maio', ano: 2024, data: '08/05/2024', valor: 2000.00, taxas: 6.50, detalhes: 'Aporte RV (VALE3, BBDC4)', ativos: makeAtivos(ap('VALE3', 'Ação', 10, 100.00, 1000.00, 3.25), ap('BBDC4', 'Ação', 20, 50.00, 1000.00, 3.25)) },
  ...
  { id: 'ap12', mes: 'Junho', ano: 2024, data: '10/06/2024', valor: 3500.00, taxas: 10.80, detalhes: 'Aporte RV (MSFT, TSLA, AAPL)', ativos: makeAtivos(ap('MSFT', 'Ação', 3, 600.00, 1800.00, 5.56), ap('TSLA', 'Ação', 5, 200.00, 1000.00, 3.08), ap('AAPL', 'Ação', 2, 350.00, 700.00, 2.16)) },
  ...
  { id: 'ap14', mes: 'Julho', ano: 2024, data: '12/07/2024', valor: 2800.00, taxas: 8.20, detalhes: 'Aporte RV (PETR4, ITUB4)', ativos: makeAtivos(ap('PETR4', 'Ação', 30, 50.00, 1500.00, 4.38), ap('ITUB4', 'Ação', 13, 100.00, 1300.00, 3.82)) },
  ...
  { id: 'ap16', mes: 'Agosto', ano: 2024, data: '15/08/2024', valor: 2200.00, taxas: 6.80, detalhes: 'Aporte RV (AAPL, MSFT)', ativos: makeAtivos(ap('AAPL', 'Ação', 3, 400.00, 1200.00, 3.70), ap('MSFT', 'Ação', 2, 500.00, 1000.00, 3.10)) },
  ...
  { id: 'ap18', mes: 'Setembro', ano: 2024, data: '10/09/2024', valor: 3200.00, taxas: 9.40, detalhes: 'Aporte RV (VALE3, BBDC4, PETR4)', ativos: makeAtivos(ap('VALE3', 'Ação', 10, 100.00, 1000.00, 2.94), ap('BBDC4', 'Ação', 20, 50.00, 1000.00, 2.94), ap('PETR4', 'Ação', 20, 60.00, 1200.00, 3.52)) },
  ...
  { id: 'ap20', mes: 'Outubro', ano: 2024, data: '12/10/2024', valor: 2500.00, taxas: 7.50, detalhes: 'Aporte RV (ITUB4, TSLA)', ativos: makeAtivos(ap('ITUB4', 'Ação', 15, 100.00, 1500.00, 4.50), ap('TSLA', 'Ação', 5, 200.00, 1000.00, 3.00)) },
  ...
  { id: 'ap22', mes: 'Novembro', ano: 2024, data: '10/11/2024', valor: 3000.00, taxas: 9.00, detalhes: 'Aporte RV (AAPL, MSFT, VALE3)', ativos: makeAtivos(ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.50), ap('MSFT', 'Ação', 2, 500.00, 1000.00, 3.00), ap('VALE3', 'Ação', 5, 100.00, 500.00, 1.50)) },
  ...
  { id: 'ap24', mes: 'Dezembro', ano: 2024, data: '15/12/2024', valor: 4500.00, taxas: 14.10, detalhes: 'Aporte 13º salário (RF + RV)', ativos: makeAtivos(ap('Tesouro SELIC', 'Renda Fixa', 1, 2500.00, 2500.00, 7.84), ap('AAPL', 'Ação', 4, 500.00, 2000.00, 6.26)) },

  // 2025
  { id: 'ap25', mes: 'Janeiro', ano: 2025, data: '08/01/2025', valor: 1800.00, taxas: 5.20, detalhes: 'Aporte RV (AAPL, MSFT)', ativos: makeAtivos(ap('AAPL', 'Ação', 2, 500.00, 1000.00, 2.88), ap('MSFT', 'Ação', 2, 400.00, 800.00, 2.32)) },
  ...
  { id: 'ap27', mes: 'Fevereiro', ano: 2025, data: '12/02/2025', valor: 2000.00, taxas: 6.20, detalhes: 'Aporte RV (PETR4, VALE3)', ativos: makeAtivos(ap('PETR4', 'Ação', 20, 50.00, 1000.00, 3.10), ap('VALE3', 'Ação', 10, 100.00, 1000.00, 3.10)) },
  ...
  { id: 'ap29', mes: 'Março', ano: 2025, data: '10/03/2025', valor: 2200.00, taxas: 6.80, detalhes: 'Aporte RV (ITUB4, BBDC4)', ativos: makeAtivos(ap('ITUB4', 'Ação', 12, 100.00, 1200.00, 3.70), ap('BBDC4', 'Ação', 20, 50.00, 1000.00, 3.10)) },
  ...
  { id: 'ap31', mes: 'Abril', ano: 2025, data: '12/04/2025', valor: 2500.00, taxas: 7.50, detalhes: 'Aporte RV (TSLA, AAPL)', ativos: makeAtivos(ap('TSLA', 'Ação', 6, 200.00, 1200.00, 3.60), ap('AAPL', 'Ação', 3, 433.33, 1300.00, 3.90)) },
  ...
  { id: 'ap33', mes: 'Maio', ano: 2025, data: '10/05/2025', valor: 2800.00, taxas: 8.40, detalhes: 'Aporte RV (MSFT, VALE3, PETR4)', ativos: makeAtivos(ap('MSFT', 'Ação', 2, 500.00, 1000.00, 3.00), ap('VALE3', 'Ação', 8, 100.00, 800.00, 2.40), ap('PETR4', 'Ação', 20, 50.00, 1000.00, 3.00)) },
  ...
  { id: 'ap35', mes: 'Junho', ano: 2025, data: '10/06/2025', valor: 3000.00, taxas: 9.20, detalhes: 'Aporte RV (AAPL, TSLA, ITUB4)', ativos: makeAtivos(ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.60), ap('TSLA', 'Ação', 5, 200.00, 1000.00, 3.06), ap('ITUB4', 'Ação', 5, 100.00, 500.00, 1.54)) },
  ...
  { id: 'ap37', mes: 'Julho', ano: 2025, data: '12/07/2025', valor: 3200.00, taxas: 9.80, detalhes: 'Aporte RV (BBDC4, MSFT, AAPL)', ativos: makeAtivos(ap('BBDC4', 'Ação', 20, 50.00, 1000.00, 3.06), ap('MSFT', 'Ação', 2, 600.00, 1200.00, 3.68), ap('AAPL', 'Ação', 2, 500.00, 1000.00, 3.06)) },
  ...
  { id: 'ap39', mes: 'Agosto', ano: 2025, data: '10/08/2025', valor: 3200.00, taxas: 9.60, detalhes: 'Aporte RV (VALE3, PETR4)', ativos: makeAtivos(ap('VALE3', 'Ação', 15, 100.00, 1500.00, 4.50), ap('PETR4', 'Ação', 34, 50.00, 1700.00, 5.10)) },
  ...
  { id: 'ap41', mes: 'Setembro', ano: 2025, data: '12/09/2025', valor: 3500.00, taxas: 10.50, detalhes: 'Aporte RV (TSLA, AAPL, ITUB4)', ativos: makeAtivos(ap('TSLA', 'Ação', 7, 200.00, 1400.00, 4.20), ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.50), ap('ITUB4', 'Ação', 6, 100.00, 600.00, 1.80)) },
  ...
  { id: 'ap43', mes: 'Outubro', ano: 2025, data: '10/10/2025', valor: 3800.00, taxas: 11.40, detalhes: 'Aporte RV (MSFT, BBDC4, VALE3)', ativos: makeAtivos(ap('MSFT', 'Ação', 3, 600.00, 1800.00, 5.40), ap('BBDC4', 'Ação', 20, 50.00, 1000.00, 3.00), ap('VALE3', 'Ação', 10, 100.00, 1000.00, 3.00)) },
  ...
  { id: 'ap45', mes: 'Novembro', ano: 2025, data: '10/11/2025', valor: 3800.00, taxas: 11.60, detalhes: 'Aporte RV (AAPL, PETR4, TSLA)', ativos: makeAtivos(ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.58), ap('PETR4', 'Ação', 26, 50.00, 1300.00, 3.96), ap('TSLA', 'Ação', 5, 200.00, 1000.00, 3.06)) },
  ...
  { id: 'ap47', mes: 'Dezembro', ano: 2025, data: '15/12/2025', valor: 4000.00, taxas: 12.50, detalhes: 'Aporte 13º salário (RF + RV)', ativos: makeAtivos(ap('Tesouro SELIC', 'Renda Fixa', 1, 2000.00, 2000.00, 6.26), ap('AAPL', 'Ação', 2, 500.00, 1000.00, 3.12), ap('MSFT', 'Ação', 2, 500.00, 1000.00, 3.12)) },
  ...
  // 2026
  { id: 'ap49', mes: 'Janeiro', ano: 2026, data: '10/01/2026', valor: 2500.00, taxas: 7.80, detalhes: 'Aporte RV (AAPL, MSFT, ITUB4)', ativos: makeAtivos(ap('AAPL', 'Ação', 2, 500.00, 1000.00, 3.12), ap('MSFT', 'Ação', 2, 500.00, 1000.00, 3.12), ap('ITUB4', 'Ação', 5, 100.00, 500.00, 1.56)) },
  ...
  { id: 'ap51', mes: 'Fevereiro', ano: 2026, data: '10/02/2026', valor: 2800.00, taxas: 8.50, detalhes: 'Aporte RV (VALE3, PETR4, BBDC4)', ativos: makeAtivos(ap('VALE3', 'Ação', 8, 100.00, 800.00, 2.42), ap('PETR4', 'Ação', 20, 50.00, 1000.00, 3.04), ap('BBDC4', 'Ação', 20, 50.00, 1000.00, 3.04)) },
  ...
  { id: 'ap53', mes: 'Março', ano: 2026, data: '10/03/2026', valor: 3000.00, taxas: 9.20, detalhes: 'Aporte RV (TSLA, AAPL, MSFT)', ativos: makeAtivos(ap('TSLA', 'Ação', 5, 200.00, 1000.00, 3.06), ap('AAPL', 'Ação', 2, 500.00, 1000.00, 3.06), ap('MSFT', 'Ação', 2, 500.00, 1000.00, 3.08)) },
  ...
  { id: 'ap55', mes: 'Abril', ano: 2026, data: '12/04/2026', valor: 3200.00, taxas: 9.80, detalhes: 'Aporte RV (ITUB4, VALE3, PETR4)', ativos: makeAtivos(ap('ITUB4', 'Ação', 10, 100.00, 1000.00, 3.06), ap('VALE3', 'Ação', 10, 100.00, 1000.00, 3.06), ap('PETR4', 'Ação', 24, 50.00, 1200.00, 3.68)) },
  ...
  { id: 'ap57', mes: 'Maio', ano: 2026, data: '10/05/2026', valor: 3500.00, taxas: 10.60, detalhes: 'Aporte RV (AAPL, TSLA, BBDC4)', ativos: makeAtivos(ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.54), ap('TSLA', 'Ação', 6, 200.00, 1200.00, 3.64), ap('BBDC4', 'Ação', 16, 50.00, 800.00, 2.42)) },
  ...
  { id: 'ap59', mes: 'Junho', ano: 2026, data: '10/06/2026', valor: 3800.00, taxas: 11.60, detalhes: 'Aporte RV (MSFT, AAPL, ITUB4)', ativos: makeAtivos(ap('MSFT', 'Ação', 3, 600.00, 1800.00, 5.50), ap('AAPL', 'Ação', 2, 500.00, 1000.00, 3.04), ap('ITUB4', 'Ação', 10, 100.00, 1000.00, 3.06)) },
  ...
  { id: 'ap61', mes: 'Julho', ano: 2026, data: '10/07/2026', valor: 3800.00, taxas: 11.40, detalhes: 'Aporte RV (VALE3, PETR4, BBDC4)', ativos: makeAtivos(ap('VALE3', 'Ação', 12, 100.00, 1200.00, 3.60), ap('PETR4', 'Ação', 26, 50.00, 1300.00, 3.90), ap('BBDC4', 'Ação', 26, 50.00, 1300.00, 3.90)) },
  ...
  { id: 'ap63', mes: 'Agosto', ano: 2026, data: '10/08/2026', valor: 4000.00, taxas: 12.20, detalhes: 'Aporte RV (AAPL, MSFT, TSLA)', ativos: makeAtivos(ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.58), ap('MSFT', 'Ação', 3, 500.00, 1500.00, 4.56), ap('TSLA', 'Ação', 5, 200.00, 1000.00, 3.06)) },
  ...
  { id: 'ap65', mes: 'Setembro', ano: 2026, data: '10/09/2026', valor: 4200.00, taxas: 12.80, detalhes: 'Aporte RV (ITUB4, BBDC4, VALE3)', ativos: makeAtivos(ap('ITUB4', 'Ação', 12, 100.00, 1200.00, 3.66), ap('BBDC4', 'Ação', 20, 50.00, 1000.00, 3.04), ap('VALE3', 'Ação', 20, 100.00, 2000.00, 6.10)) },
  ...
  { id: 'ap67', mes: 'Outubro', ano: 2026, data: '10/10/2026', valor: 4500.00, taxas: 13.60, detalhes: 'Aporte RV (PETR4, AAPL, TSLA)', ativos: makeAtivos(ap('PETR4', 'Ação', 30, 50.00, 1500.00, 4.54), ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.52), ap('TSLA', 'Ação', 7, 214.29, 1500.00, 4.54)) },
  ...
  { id: 'ap69', mes: 'Novembro', ano: 2026, data: '10/11/2026', valor: 4800.00, taxas: 14.40, detalhes: 'Aporte RV (MSFT, AAPL, ITUB4)', ativos: makeAtivos(ap('MSFT', 'Ação', 3, 600.00, 1800.00, 5.40), ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.50), ap('ITUB4', 'Ação', 15, 100.00, 1500.00, 4.50)) },
  ...
  { id: 'ap71', mes: 'Dezembro', ano: 2026, data: '15/12/2026', valor: 5000.00, taxas: 15.50, detalhes: 'Aporte 13º salário (RF + RV)', ativos: makeAtivos(ap('Tesouro SELIC', 'Renda Fixa', 1, 2500.00, 2500.00, 7.76), ap('AAPL', 'Ação', 3, 500.00, 1500.00, 4.64), ap('MSFT', 'Ação', 2, 500.00, 1000.00, 3.10)) },
