...
export const MOCK_PRODUCTS: PortfolioProduct[] = [
  { ticker: 'AAPL', tipo: AssetTypeEnum.ACOES, qtd: 10, precoMedio: 180.00, custoTotal: 1800.00, precoAtual: 183.05, valorAtual: 1830.50, lucroPrejuizo: 30.50, lucroPrejuizoPct: 1.69, participacao: 15.2 },
  { ticker: 'TSLA', tipo: AssetTypeEnum.ACOES, qtd: 5, precoMedio: 170.00, custoTotal: 850.00, precoAtual: 171.89, valorAtual: 859.45, lucroPrejuizo: 9.45, lucroPrejuizoPct: 1.11, participacao: 7.1 },
  { ticker: 'MSFT', tipo: AssetTypeEnum.ACOES, qtd: 20, precoMedio: 410.00, custoTotal: 8200.00, precoAtual: 415.50, valorAtual: 8310.00, lucroPrejuizo: 110.00, lucroPrejuizoPct: 1.34, participacao: 38.4 },
  { ticker: 'PETR4', tipo: AssetTypeEnum.ACOES, qtd: 100, precoMedio: 38.00, custoTotal: 3800.00, precoAtual: 41.20, valorAtual: 4120.00, lucroPrejuizo: 320.00, lucroPrejuizoPct: 8.42, participacao: 18.5 },
  { ticker: 'VALE3', tipo: AssetTypeEnum.ACOES, qtd: 50, precoMedio: 60.00, custoTotal: 3000.00, precoAtual: 62.40, valorAtual: 3120.00, lucroPrejuizo: 120.00, lucroPrejuizoPct: 4.00, participacao: 12.3 },
  { ticker: 'ITUB4', tipo: AssetTypeEnum.ACOES, qtd: 80, precoMedio: 26.00, custoTotal: 2080.00, precoAtual: 27.50, valorAtual: 2200.00, lucroPrejuizo: 120.00, lucroPrejuizoPct: 5.77, participacao: 8.5 },
  { ticker: 'MXRF11', tipo: AssetTypeEnum.FII, qtd: 150, precoMedio: 9.80, custoTotal: 1470.00, precoAtual: 10.15, valorAtual: 1522.50, lucroPrejuizo: 52.50, lucroPrejuizoPct: 3.57, participacao: 6.8 },
  { ticker: 'XPML11', tipo: AssetTypeEnum.FII, qtd: 30, precoMedio: 110.00, custoTotal: 3300.00, precoAtual: 115.00, valorAtual: 3450.00, lucroPrejuizo: 150.00, lucroPrejuizoPct: 4.55, participacao: 15.4 },
  { ticker: 'BABA34', tipo: AssetTypeEnum.BDR, qtd: 40, precoMedio: 52.00, custoTotal: 2080.00, precoAtual: 55.30, valorAtual: 2212.00, lucroPrejuizo: 132.00, lucroPrejuizoPct: 6.35, participacao: 6.2 },
  { ticker: 'IVVB11', tipo: AssetTypeEnum.ETF, qtd: 15, precoMedio: 220.00, custoTotal: 3300.00, precoAtual: 235.00, valorAtual: 3525.00, lucroPrejuizo: 225.00, lucroPrejuizoPct: 6.82, participacao: 8.1 },
  { ticker: 'BTC', tipo: AssetTypeEnum.CRIPTO, qtd: 0.5, precoMedio: 180000.00, custoTotal: 90000.00, precoAtual: 195000.00, valorAtual: 97500.00, lucroPrejuizo: 7500.00, lucroPrejuizoPct: 8.33, participacao: 18.5 },
  { ticker: 'SELIC', tipo: 'Renda Fixa', qtd: 15000, precoMedio: 1.00, custoTotal: 15000.00, precoAtual: 1.00, valorAtual: 15930.00, lucroPrejuizo: 930.00, lucroPrejuizoPct: 6.20, participacao: 6.8 },
];
